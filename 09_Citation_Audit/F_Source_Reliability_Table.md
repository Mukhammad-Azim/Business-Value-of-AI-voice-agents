...
|---|---|---|
| **High** | Audited or peer-reviewed; independently verifiable | SEC 10-K (audited financial statements), peer-reviewed journal articles |
| **Medium-high** | Issued by an authoritative institution but not externally audited; or working papers / conference proceedings under formal review | NBER working papers, MBA industry reports, Federal Reserve research notes |
| **Medium** | Authoritative but management-attested or institutional self-disclosure (subject to selection/promotion bias) | Earnings press releases (8-K Exhibit 99.1), management commentary, investor presentations, company webpages |
| **Low** | Vendor-issued promotional material or self-selected user-generated content | Vendor case studies, vendor blog posts, BusinessWire press copy, Trustpilot reviews |
| **Contextual** | Reputable but third-party reportage of management claims; useful for triangulation but not primary evidence | News outlets (HousingWire, Axios, National Mortgage News) |
...
| 6 | Better HoldCo, Inc. (2021) — bridge-financing press release | Press release | **Medium** | Pre-merger SPAC-deal context | Frame as "Better announced…" (management claim); cross-reference Primack (2021) for independent reportage |
| 7 | Better.com (n.d.) — *Our company* webpage | Corporate webpage | **Medium** | Mission/vision/corporate-context statements | Use only for descriptive context, not as evidentiary support |
| 8 | Better Home & Finance Holding Company (n.d.) — IR Corporate Overview | Corporate webpage | **Medium** | Investor-facing company description | Use only for descriptive context |
| 9 | Better Home & Finance Holding Company, & ElevenLabs (2026) — joint press release | Joint press release (Business Wire) | **Low–Medium** (vendor + management combined) | "115k → 700k monthly interactions"; "+30% conversion uplift"; deployment-scale claims | **Qualify strongly**: "according to a joint announcement by Better and ElevenLabs (2026), figures that have not been independently audited and may be subject to promotional framing" |
| 10 | ElevenLabs (2026) — vendor case study / blog | Vendor blog | **Low** (promotional) | Voice-engine implementation; latency targets; agent architecture | **Qualify strongly**: "According to ElevenLabs' own case study (2026), a vendor-issued source that is promotional in nature…" |
| 11 | Mortgage Bankers Association (2024a, 2024b) | Industry research / press release | **Medium-high** | Industry-average production cost per loan; quarterly IMB profitability | Cite directly; MBA is the authoritative trade-association data source |
| 12 | Rocket Companies, Inc. (2024, 2025) — 10-K filings | SEC filing — audited annual reports | **High** | Comparator firm financials | No qualification needed |
| 13 | Federal Reserve Bank of New York (2023) — Liberty Street Economics post | Research note | **High** | Pandemic refinance-boom context | No qualification needed |
| 14 | Freddie Mac (2024) — *2024 cost to originate study* | Industry research | **Medium-high** | Cost-to-originate benchmark | Cite directly; Freddie Mac is GSE authority |
| 15 | Freddie Mac (2021) — *Refinance trends in 2020* | Industry research note | **Medium-high** | 2020 refinance volume context | Cite directly |
| 16 | Fannie Mae (n.d.) — *Selling guide* | Institutional reference document | **High** | Underwriting / closing process descriptions | No qualification needed |
| 17 | Consumer Financial Protection Bureau (2024, 2025) | Government webpage | **High** | Closing-process and consumer-disclosure descriptions | No qualification needed |
| 18 | Acemoglu & Restrepo (2019) — *Journal of Economic Perspectives* | Peer-reviewed academic article | **High** | Automation/displacement-and-reinstatement framework | No qualification needed |
| 19 | Adam et al. (2021) — *Electronic Markets* | Peer-reviewed academic article | **High** | Chatbot-compliance experimental findings | No qualification needed |
| 20 | Aggarwal et al. (2025) — *European Journal of Marketing* | Peer-reviewed academic article | **High** | Voice-AI value-creation/appropriation framework | No qualification needed |
| 21 | Andrade & Tumelero (2022) — *Revista de Gestão* | Peer-reviewed academic article | **High** | Customer-service efficiency through AI chatbots | No qualification needed |
| 22 | Becker et al. (2025) — *ACM ToHRI* | Peer-reviewed academic article | **High** | Voice-naturalness/trust-and-compliance findings | No qualification needed |
| 23 | Blümel et al. (2024) — *Journal of Service Theory and Practice* | Peer-reviewed academic article | **High** | Relational-personalization conceptual framework | No qualification needed |
| 24 | Brynjolfsson, Li, & Raymond (2023) — NBER Working Paper | Working paper (NBER) | **Medium-high** | Generative-AI-at-work productivity findings | Note "working paper, pre-publication" if precision is critical |
| 25 | Filieri (2015) — *Tourism Management* | Peer-reviewed academic article | **High** | UGC trust antecedents | No qualification needed |
| 26 | Fotheringham & Wiles (2023) — *JAMS* | Peer-reviewed academic article | **High** | Stock-return event study on chatbot adoption | No qualification needed |
| 27 | Goodhue & Thompson (1995) — *MIS Quarterly* | Peer-reviewed academic article (foundational) | **High** | Task-technology-fit framework | No qualification needed |
| 28 | Grootendorst (2022) — arXiv | Pre-print / methods paper | **Medium-high** | BERTopic methodology | Cite as methodological reference |
| 29 | Hentzen et al. (2022) — *IJBM* | Peer-reviewed systematic literature review | **High** | AI in financial services SLR | No qualification needed |
| 30 | Heskett et al. (1994) — *Harvard Business Review* | Practitioner-academic journal article (foundational) | **High** | Service-profit-chain framework | No qualification needed |
| 31 | Hevner et al. (2004) — *MIS Quarterly* | Peer-reviewed academic article | **High** | Design-science research framework | No qualification needed |
| 32 | Huang & Rust (2018) — *Journal of Service Research* | Peer-reviewed academic article | **High** | AI-in-service typology | No qualification needed |
| 33 | Hutto & Gilbert (2014) — *ICWSM* | Peer-reviewed conference paper | **High** | VADER methodology | No qualification needed |
| 34 | Liu, Zhang, & Zhang (2024) — *International Studies of Economics* | Peer-reviewed academic article | **High** | AI-and-investment-efficiency findings | No qualification needed |
| 35 | Luca (2016) — HBS working paper | Working paper | **Medium-high** | Yelp-rating economic impact | Note "working paper" if precision is critical |
| 36 | Maslych et al. (2025) — arXiv | Pre-print | **Medium-high** | LLM-IVA latency-mitigation methods | Pre-print qualifier |
| 37 | Mogaji & Nguyen (2021) — *IJBM* | Peer-reviewed academic article | **High** | Manager-AI understanding cross-country study | No qualification needed |
| 38 | Nussbaum, Frühholz, & Schweinberger (2025) — *Trends in Cognitive Sciences* | Peer-reviewed review article | **High** | Voice-naturalness perception | No qualification needed |
| 39 | Wang, Huang, Hong, Liu, Guo, & Chen (2023) — *Production and Operations Management* | Peer-reviewed academic article (field experiment) | **High** | Voice-AI call-center field experiment | No qualification needed |
| 40 | Xu et al. (2020) — *Australasian Marketing Journal* | Peer-reviewed academic article | **High** | AI-customer-service task-complexity findings | No qualification needed |
| 41 | Yin (2018) — SAGE | Methods textbook (6th ed.) | **High** | Case-study research methodology | No qualification needed |
| 42 | Zhang, Li, & Liu (2023) — *Applied Artificial Intelligence* | Peer-reviewed academic article | **High** | AI conversational-agent operational performance | No qualification needed |
| 43 | Abdulquadri, Mogaji, Kieu, & Nguyen (2021) — *JEC* | Peer-reviewed academic article | **High** | Chatbot adoption in Nigerian financial services | No qualification needed |
